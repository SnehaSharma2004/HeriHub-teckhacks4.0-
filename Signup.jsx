    ...
    <section className="w-full">
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div className="py-6 bg-indigo-100 lg:bg-white flex justify-between lg:justify-start lg:px-12">
            ...
            <div className="mt-6">
              <form onSubmit={onSubmit}>
                ...
                <div className="w-1/2">
                  ...
                  <input
                    className="w-full text-sm border-b border-gray-300 focus:outline-none focus:border-indigo-500 rounded-full py-2 px-4"
                    id="name"
                    type="text"
                    value={name}
                    onChange={onChange}
          ...
          />
                ...
                <div className="w-1/2">
                  ...
                  <div className="relative flex w-full">
                    <input
                      className="w-full text-sm py-2 px-4 border-b border-gray-300 focus:outline-none focus:border-indigo-500 rounded-full"
                      id="password"
                ...
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    required
                    placeholder="www.example.com/linkedin"
                  />
                </div>
                <div className="w-1/2">
                  <div className="text-xs font-bold text-gray-700 tracking-wide px-2 py-2">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    required
                    placeholder="www.example.com/instagram"
                  />
                </div>
                </div>
                <div className="mt-2">
