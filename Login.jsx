...
import { toast } from "react-toastify"; //info on banner
            ...
            <div className="mt-12">
              <form onSubmit={onSubmit}>
                <div>
                  ...
                  <input
                    className="w-full text-lg border-b border-gray-300 focus:outline-none focus:border-indigo-500 rounded-full py-4 px-4"
                    id="email"
                    type="email"
                    value={email}
                    onChange={onChange}
                ...
                <div className="mt-8">
                  ...
                  <div className="relative flex w-full">
                    <input
                      className="w-full text-lg py-4 px-4 border-b border-gray-300 focus:outline-none focus:border-indigo-500 rounded-full"
                      id="password"
